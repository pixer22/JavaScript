...
function height_handler(){if($(window).width()>465){$(".maxheight").equalHeights();}else{$(".maxheight").css({'height':'auto'});}
if($(window).width()>465){$(".maxheight2").equalHeights();}else{$(".maxheight2").css({'height':'auto'});}
if($(window).width()>740){$(".maxheight3").equalHeights();}else{$(".maxheight3").css({'height':'auto'});}}
